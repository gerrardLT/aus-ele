...
FINLAND_BOARD_FIELDS = {
    ...
    "fcr_n_volume_mw": {
        "field_key": "fcr_n_volume_mw",
        "label": "FCR-N Procured Volume",
        "unit": "MW",
        "granularity": "1h",
        "source_name": "Fingrid",
        "source_dataset_id": "316",
        "source_type": "live",
        "category": "capacity_volume",
        "methodology_note": "Hourly procured FCR-N reserve volume.",
    },
    ...
    "fcr_d_up_volume_mw": {
        "field_key": "fcr_d_up_volume_mw",
        "label": "FCR-D Up Procured Volume",
        "unit": "MW",
        "granularity": "1h",
        "source_name": "Fingrid",
        ...
        "source_type": "live",
        "category": "capacity_volume",
        "methodology_note": "Hourly procured FCR-D up reserve volume.",
    },
    "fcr_d_down_price_eur_mw": {
        ...
        "granularity": "1h",
        "source_name": "Fingrid",
        "source_dataset_id": "283",
        "source_type": "live",
        "category": "capacity",
        "methodology_note": "Hourly FCR-D down reserve-capacity clearing price.",
    },
    "fcr_d_down_volume_mw": {
        "field_key": "fcr_d_down_volume_mw",
        "label": "FCR-D Down Procured Volume",
        "unit": "MW",
        "granularity": "1h",
        "source_name": "Fingrid",
        "source_dataset_id": "281",
        "source_type": "live",
        "category": "capacity_volume",
        "methodology_note": "Hourly procured FCR-D down reserve volume.",
    },
    "afrr_cap_up_eur_mw": {
