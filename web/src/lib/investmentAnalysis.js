const DEFAULT_INVESTMENT_COPY = {
  en: {
    ...
    regimeNarrativeTitle: 'Regime Narrative',
    regimeNarrativeEmpty: 'Regime context is not available for the current investment run.',
    regimeNarrativePrimary: 'Primary regime',
    regimeNarrativeDriver: 'Top driver',
    regimeNarrativeTransition: 'Transition watch',
    regimeNarrativeFinance: 'Financial lens',
