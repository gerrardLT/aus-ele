...
CONNECTOR_SPECS = (
    ...
    ConnectorSpec(
        ...
        notes="Represents Fingrid dataset 281 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
        source_id="fingrid_dataset_283",
        market="FINGRID",
        entrypoint="fingrid.service.sync_dataset",
        run_modes=("incremental", "backfill"),
        backfill_policy="dataset_windowed_backfill",
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 283 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
        source_id="fingrid_dataset_288",
        market="FINGRID",
        entrypoint="fingrid.service.sync_dataset",
        run_modes=("incremental", "backfill"),
        backfill_policy="dataset_windowed_backfill",
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 288 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
        source_id="fingrid_dataset_290",
        market="FINGRID",
        entrypoint="fingrid.service.sync_dataset",
        run_modes=("incremental", "backfill"),
        backfill_policy="dataset_windowed_backfill",
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 290 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
        source_id="fingrid_dataset_315",
        market="FINGRID",
        entrypoint="fingrid.service.sync_dataset",
        run_modes=("incremental", "backfill"),
        backfill_policy="dataset_windowed_backfill",
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 315 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
        source_id="fingrid_dataset_316",
        market="FINGRID",
        entrypoint="fingrid.service.sync_dataset",
        run_modes=("incremental", "backfill"),
        backfill_policy="dataset_windowed_backfill",
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 316 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
    ...
    ConnectorSpec(
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 318 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
        source_id="fingrid_dataset_319",
        market="FINGRID",
        entrypoint="fingrid.service.sync_dataset",
        run_modes=("incremental", "backfill"),
        backfill_policy="dataset_windowed_backfill",
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 319 using the normalized timeseries pipeline.",
    ),
    ConnectorSpec(
        source_id="fingrid_dataset_321",
        market="FINGRID",
        entrypoint="fingrid.service.sync_dataset",
        run_modes=("incremental", "backfill"),
        backfill_policy="dataset_windowed_backfill",
        ...
        observation_kind="actual",
        adapter="map_fingrid_timeseries_row",
        notes="Represents Fingrid dataset 321 using the normalized timeseries pipeline.",
    ),
)
