...
function buildSteps(zh) {
  return [
    ...
    },
    {
      ...
      body: zh
        ? 'NEM / WEM 双市场、AI 编排分析、报告中心、定价与账户都在这里。登录后可在「账户中心」管理成员、API Key 与告警。'
        : 'NEM/WEM markets, AI analysis, report center, pricing and account live here. After signing in, manage members, API keys and alerts in the Account Center.',
      placement: 'right',
    },
    {
      id: 'stages',
