...
const FAQS = {
  zh: [
    ...
    ['天枢 · AI 决策引擎能问什么？', '市场对比、价格异动归因、储能收益测算、政策影响等基于本系统数据的问题。AI 只使用系统内数据回答，每个结论附规则与数据边界说明。'],
  ...
  en: [
    ...
    ['What can I ask Tianshu (AI Decision Engine)?', 'Market comparisons, price-spike attribution, storage revenue estimates, policy impact — all grounded in this system\'s data, with rule and data-boundary annotations.'],
