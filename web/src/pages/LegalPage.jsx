...
const CONTENT = {
  terms: {
    zh: {
      title: '服务条款',
      sections: [
        ['1. 服务说明', '本平台（AEMO Intelligence）提供澳洲 NEM/WEM 电力市场数据分析、储能收益判断与 AI 决策引擎服务。平台为邀请制，账户与工作空间由管理员创建与授权。'],
    ...
    en: {
      ...
      sections: [
        ['1. Service', 'AEMO Intelligence provides Australian NEM/WEM electricity market analytics, storage revenue assessment and AI Decision Engine. The platform is invite-only; accounts and workspaces are created and authorized by administrators.'],
